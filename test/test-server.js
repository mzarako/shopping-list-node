    ...
    it('should list items on get', function(done) {
    	chai.request(app)
    		...
    		.end(function(err, res) {
                ...
                res.body[0].name.should.equal('Sweet Potatoes');
                res.body[1].name.should.equal('Ginger');
                res.body[2].name.should.equal('Avocado');
    			done();
    		})
    });
    ...
    it('should edit an item on put', function(done) {
    	chai.request(app)
    		...
    		.end(function(err, res) {
    			...
    			res.body.name.should.be.a('string');
    			res.body.id.should.be.a('number');
                res.body.name.should.equal('Kittens');
                storage.items.should.be.a('array');
                storage.items.should.have.length(4);
                ...
                storage.items[0].name.should.equal('Kittens');
                done();
    		});
    });
    ...
    it('should delete an item on delete', function(done) {
    	chai.request(app)
    		...
    		.end(function(err, res) {
                ...
                storage.items[1].name.should.equal('Avocado');
    			done();
    		})
    });
});
